...
export interface futuredatepdc {
...
@Component({
  selector: 'app-futuredatepdc',
  templateUrl: './futuredatepdc.component.html',
  styleUrls: ['./futuredatepdc.component.scss']
})
export class FuturedatepdcComponent implements OnInit {
  ...
  exinfodetails(){
    this.exceptioninfoDetails = {
      ...
      PDCReleasedDate:this.exceptionInfo.PDCReleasedDate,
      AmountReceivedAndProcessed:this.exceptionInfo.AmountReceivedAndProcessed
    }

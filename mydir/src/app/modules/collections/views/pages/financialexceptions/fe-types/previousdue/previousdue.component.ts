...
@Component({
  selector: 'app-previousdue',
  templateUrl: './previousdue.component.html',
  styleUrls: ['./previousdue.component.scss']
})
export class PreviousdueComponent implements OnInit {
